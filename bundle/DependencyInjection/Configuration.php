                ...
                ->children()
                    ...
                    ->arrayNode('field_type_metas')
                        ...
                        ->children()
                                ...
                                ->scalarNode('type')->defaultValue('ezstring')->example('ezstring or ezimage')->end()
                                ...
                                ->scalarNode('image_alias')->defaultValue('ibexa_seo_toolkit_og_image1200x630')->example('ibexa_seo_toolkit_og_image1200x630 or another image_alias')->end()
                        ->end()
                        ->end()
                    ->end()
